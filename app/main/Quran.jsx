        ...
        <View style={styles.ayahHeader}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
            <TouchableOpacity onPress={() => { setReferenceModalAyah(item); setReferenceModalVisible(true); }} style={styles.iconButton}>
              <Ionicons name="library-outline" size={ms(25)} color="#3b82f6" />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => handleToggleBookmark(item)} style={styles.iconButton}>
              <Ionicons name={bookmarkedAyahs.has(String(item.id)) ? 'bookmarks' : 'bookmarks-outline'} size={ms(21)} color="#3b82f6" />
            </TouchableOpacity>
            ...
            >
              <Ionicons name="share-social-outline" size={ms(26)} color="#3b82f6" />
            </TouchableOpacity>
            ...
            {bufferingAyahId === item.id && (
              <View style={{ position: 'absolute', left: ms(5), top: ms(5) }}>
                <ActivityIndicator size="small" color={scheme === 'dark' ? '#3b82f6' : '#0f172a'} />
              </View>
            )}
          </View>
        </View>
      ...
      {translationsKeys && (
        ...
        >
          <QuranLanguageSheet
            ...
            isDarkMode={scheme === 'dark'}
            accentColor={scheme === 'dark' ? '#3b82f6' : '#0f172a'}
