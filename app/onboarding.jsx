...
export default function Onboarding() {
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      // Navigation will happen immediately
          ...
          >
            {downloading ? (
              <View style={{ width: '100%', paddingHorizontal: 20 }}>
                <Text style={[styles.buttonText, { marginBottom: 6, fontSize: 14, alignSelf: 'center' }]}>
                  Downloading Assets... {Math.round(downloadProgress * 100)}%
                </Text>
                <View style={{ width: '100%', height: 4, backgroundColor: 'rgba(255,255,255,0.3)', borderRadius: 2 }}>
                  <View style={{ width: `${downloadProgress * 100}%`, height: '100%', backgroundColor: '#fff', borderRadius: 2 }} />
                </View>
              </View>
            ) : submitting ? (
